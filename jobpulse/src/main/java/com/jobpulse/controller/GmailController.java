...
public class GmailController {
  ...
  /** Returns the Google OAuth consent URL. The frontend opens this URL in a popup / redirect. */
  @GetMapping("/auth-url")
  ...
  /**
   * Called after the user authorises in Google's consent screen. The frontend sends the
   * authorization code it received from the redirect.
   */
