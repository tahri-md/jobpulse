...
public class JobController {
  ...
  public ResponseEntity<JobResponse> createJobFull(
      @RequestBody JobRequestDTO request, @AuthenticationPrincipal User user) {
  ...
  public ResponseEntity<Void> bulkOperation(
      @RequestBody BulkJobOperationDTO request, @AuthenticationPrincipal User user) {
    log.info(
  ...
  public ResponseEntity<List<JobResponse>> filterByStatus(
      @RequestParam Status status, @AuthenticationPrincipal User user) {
  ...
  public ResponseEntity<List<JobResponse>> filterByDateRange(
      ...
      @AuthenticationPrincipal User user) {
    log.debug(
        "Filtering jobs by date range: {} to {} for user: {}", startDate, endDate, user.getId());
