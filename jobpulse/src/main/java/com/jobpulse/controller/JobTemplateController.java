...
public class JobTemplateController {
  ...
  public ResponseEntity<JobTemplateResponse> createTemplate(
      @RequestBody JobTemplateRequestDTO request, @AuthenticationPrincipal User user) {
  ...
  @GetMapping
  public ResponseEntity<List<JobTemplateResponse>> getAvailableTemplates(
  ...
  @GetMapping("/own")
  public ResponseEntity<List<JobTemplateResponse>> getOwnTemplates(
      @AuthenticationPrincipal User user) {
