...
public class AuthService {
    ...
    public AuthResponse login(LoginRequest request) {
        ...
        String accessToken = tokenProvider.generateAccessTokenFromUserId(user.getId(),
    ...
    public AuthResponse refreshToken(RefreshTokenRequest request) {
        ...
        String newAccessToken = tokenProvider.generateAccessTokenFromUserId(user.getId(),
    ...
    public void sendEmailVerification(User user) {
        ...
        emailService.sendEmailVerification(user.getEmail(), user.getUsername(),
                token);
    }
    ...
    private UserDto mapToUserDto(User user) {
        List<String> providers = user.getIdentities() == null || user.getIdentities().isEmpty()
                ? List.of("NATIVE")
                : user.getIdentities().stream()
                        .map(i -> i.getProvider().toString())
                        .toList();
