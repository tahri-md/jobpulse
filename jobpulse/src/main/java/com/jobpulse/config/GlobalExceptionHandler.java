...
/**
 * Global exception handler for REST endpoints. Provides consistent error responses across the
 * application.
 */
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleJobExecutionException(
  ...
  // public ResponseEntity<ErrorResponse> handleValidationException(MethodArgumentNotValidException
