...
public class JwtService {
    ...
    public String generateAccessTokenFromUserId(UUID userId, Collection<? extends GrantedAuthority> authorities) {
    ...
    public String generateRefreshTokenFromUserId(UUID userId) {
        return generateTokenFromUserId(userId, jwtRefreshTokenExpiration, Collections.emptyList(), true);
    }

    private String generateToken(Authentication authentication, long expirationTime, boolean isRefreshToken) {
    ...
    private String generateTokenFromUserId(UUID userId, long expirationTime,
    ...
    private String generateTokenWithClaims(Map<String, Object> claims, String subject, long expirationTime) {
        Date now = new Date();
