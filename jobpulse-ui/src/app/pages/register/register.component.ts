    ...
    <div class="auth-page">
      <div class="auth-card">
        <div class="auth-header">
          ...
          <p>Sign up for JobPulse</p>
        </div>

        <!-- OAuth Buttons -->
        <div class="oauth-buttons">
          <button class="btn btn-oauth btn-google" (click)="onGoogleSignUp()" [disabled]="oauthLoading">
          ...
          <button class="btn btn-oauth btn-github" (click)="onGitHubSignUp()" [disabled]="oauthLoading">
            <svg viewBox="0 0 24 24" width="18" height="18">
        ...
        <form (ngSubmit)="onRegister()" class="auth-form">
          <div class="form-group">
            ...
            <input id="username" type="text" [(ngModel)]="username" name="username" placeholder="Choose a username" required autocomplete="username" />
          </div>

          <div class="form-group">
            <label for="email">Email</label>
            <input id="email" type="email" [(ngModel)]="email" name="email" placeholder="Enter your email" required autocomplete="email" />
          </div>

          <div class="form-group">
            <label for="password">Password</label>
            <input id="password" type="password" [(ngModel)]="password" name="password" placeholder="Create a password" required autocomplete="new-password" />
          </div>

          <div class="form-group">
            <label for="confirmPassword">Confirm Password</label>
            <input id="confirmPassword" type="password" [(ngModel)]="confirmPassword" name="confirmPassword" placeholder="Confirm your password" required autocomplete="new-password" />
          </div>
