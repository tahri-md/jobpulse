      ...
      @if (loading) {
        ...
        <div class="page-header">
          <div>
            ...
            <h1>{{ job.name }}</h1>
            <span class="badge" [class]="'badge badge-' + (job.status || '').toLowerCase()">{{
              job.status
            }}</span>
          </div>
        ...
        <div class="info-grid">
          <div class="info-card">
            <h3>General</h3>
            <div class="info-row">
              <span class="info-label">ID</span><span class="info-value mono">#{{ job.id }}</span>
            </div>
            <div class="info-row">
              <span class="info-label">Name</span><span class="info-value">{{ job.name }}</span>
            </div>
            <div class="info-row">
              <span class="info-label">Type</span
              ><span class="info-value"
                ><span class="badge badge-type">{{ job.jobType }}</span></span
              >
            </div>
            <div class="info-row">
          ...
          <div class="info-card">
            ...
            <div class="info-row">
              ...
              ><span class="info-value">{{ job.recurring ? 'Yes' : 'No' }}</span>
            </div>
            <div class="info-row">
              <span class="info-label">Max Retries</span
              ><span class="info-value mono">{{ job.maxRetries }}</span>
            </div>
            <div class="info-row">
              <span class="info-label">Retry Count</span
              ><span class="info-value mono">{{ job.retryCount }}</span>
            </div>
            <div class="info-row">
              <span class="info-label">Next Run</span
              ><span class="info-value">{{
                job.nextRunTime ? (job.nextRunTime | date: 'medium') : '—'
              }}</span>
            </div>
          </div>
          ...
          @if (job.cronExpression) {
            <div class="info-card">
              ...
              <div class="info-row">
                ...
                ><span class="info-value mono">{{ job.cronExpression }}</span>
              </div>
            </div>
          }
                  ...
                  @for (h of history; track h.id) {
                    <tr>
                      ...
                      <td>
                        <span
                          class="badge"
                          [class]="'badge badge-' + (h.status || '').toLowerCase()"
                          >{{ h.status }}</span
                        >
                      </td>
