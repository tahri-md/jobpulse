...
@Component({
  ...
  template: `
    <div class="auth-page">
      <div class="auth-card">
        ...
        <!-- Loading State -->
        <div *ngIf="verificationState === 'loading'" class="verification-content">
        ...
        <div *ngIf="verificationState === 'success'" class="verification-content success">
          ...
          <p class="status-description">Your account is now active. You can log in with your credentials.</p>
        ...
        <!-- Error State -->
        <div *ngIf="verificationState === 'error'" class="verification-content error">
        ...
        <!-- Invalid Token State -->
        <div *ngIf="verificationState === 'invalid'" class="verification-content error">
          <div class="error-icon">!</div>
        ...
        <div class="auth-footer" *ngIf="verificationState !== 'success'">
  ...
  styles: [`
    ...
    .verification-content { display: flex; flex-direction: column; align-items: center; gap: 16px; }
    ...
    .error-icon {
      width: 64px; height: 64px; background: #ef4444; color: white;
      border-radius: 50%; display: flex; align-items: center; justify-content: center;
      font-size: 32px; font-weight: 700;
    }

    .status-message {
      font-size: 18px; font-weight: 600; color: var(--text-primary); margin: 8px 0 0;
      text-align: center;
    }
    .status-description {
    ...
    .btn {
      padding: 11px 16px; border: none; border-radius: 6px; font-size: 13px;
    ...
    .verification-content.success { gap: 20px; }
    .verification-content.error { gap: 20px; }
  `]
})
