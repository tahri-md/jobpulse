import { inject, Component, signal, output } from '@angular/core';
  ...
  template: `
    <aside class="sidebar" [class.collapsed]="collapsed()">
      ...
      <nav class="sidebar-nav">
        ...
        <a
          routerLink="/dead-letter"
          routerLinkActive="active"
          class="nav-item"
          [title]="collapsed() ? 'Dead Letter Queue' : ''"
        >
          <svg class="nav-icon" viewBox="0 0 20 20" fill="currentColor">
            <path d="M10 2L2 7v6l8 5 8-5V7L10 2zm0 3l5 3-5 3-5-3 5-3z" />
          </svg>
        ...
        <div class="footer-bottom">
          ...
          <button class="logout-btn" (click)="auth.logout()" title="Logout">
            <svg viewBox="0 0 20 20" fill="currentColor" width="18" height="18">
              <path d="M3 3h8v2H5v10h6v2H3V3zm10 4l4 3-4 3V7zm-3 2h6v2h-6v-2z" />
            </svg>
          </button>
        </div>
      </div>
